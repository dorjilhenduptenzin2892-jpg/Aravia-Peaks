      ...
      <div className="container mx-auto px-4 py-14 md:px-6">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-foreground">Bhutan Aravia Peaks</h3>
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border text-foreground/70 hover:text-foreground hover:border-foreground/30 transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li>
                <Link href="/packages" className="text-foreground/80 hover:text-foreground transition-colors">
                  Tour Packages
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/travel-guide" className="text-foreground/80 hover:text-foreground transition-colors">
                  Travel Guide
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/festivals" className="text-foreground/80 hover:text-foreground transition-colors">
                  Festival Calendar
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Popular Packages</h4>
            <ul className="mt-4 space-y-3 text-sm">
              <li>
                <Link href="/packages/paro-tshechu" className="text-foreground/80 hover:text-foreground transition-colors">
              ...
              <li>
                <Link href="/packages/druk-path-trek" className="text-foreground/80 hover:text-foreground transition-colors">
                  Druk Path Trek
                </Link>
              </li>
              <li>
                <Link href="/packages/luxury-bhutan" className="text-foreground/80 hover:text-foreground transition-colors">
                  Luxury Experiences
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-foreground/80">
              ...
              <li>
                <a href="tel:+97517565604" className="hover:text-foreground transition-colors">
                  +975 17565604
                </a>
              </li>
              <li>
                <a href="mailto:dorjicrypto1995@gmail.com" className="hover:text-foreground transition-colors">
                  dorjicrypto1995@gmail.com
                </a>
              </li>
            </ul>
          </div>
